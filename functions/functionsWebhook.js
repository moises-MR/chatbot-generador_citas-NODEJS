...
const evaluateMessage = async  (recipientId,message,idClientFacebook) => {
    ...
    //         },
    //         opcion4:{
    //             message:"Este mes de agosto tenemos los sitios web 🌐 básicos, adaptables a todo tipo de dispositivo ya sean tabletas, móviles 📱 o pc 💻, además hospedaje para tu pagina web y dominio por un año GRATIS por tan solo $ 2,999,  ¿te interesa? Pídeme que te contacte con un asesor para mas información. ",
    ...
    //         opcionVictoria:{
    //             message:"Tener un asistente virtual las 24 horas 🏪 los 7 dias de las semana, para contestar todos tus mensajes y responder rapido a las dudas de tus clientes.                                                                                                     No esperes mas adquiere cualquiera de nuestros paquetes y permite una mejor experiencia al usuario en tu negocio.",
    ...
    //         },
    //         interesCita:{
    //             message:"Para cuando la cita joven",
...
if(existeUser[0].interesCita){
    ...
    // if(arrayDays.length <= 2 ){
    //     arrayDays.push("No disponible")
    //     arrayDays.push("No disponible")
    // }
